...
class MediaConnectionViewController: UIViewController, UINavigationControllerDelegate, UIAlertViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.peer = SKWPeer(id: "okasan"/*nil*/, options: option)
        ...
        rcLocal.origin.x = rcScreen.size.width - rcLocal.size.width - 20.0
        rcLocal.origin.y = rcScreen.size.height - rcLocal.size.height - 22.0
